...
<div class="rsc-welcome-screen">
    ...
    <div class="rsc-free-features">
        ...
        <span><?php
            if (restrict_fs()->can_use_premium_code()) {
                ...
                esc_html_e('Restrict PRO features', 'restricted-content');
            } else {
                $welcome_widgets_copy = rsc_welcome_widget_copy('free');
                esc_html_e('Restrict free plan features', 'restricted-content');
            }
            ?>
        </span>
        ...
        <div class="rsc-sections-wrap">
            ...
            <div class="rsc-half-section">
                ...
                <div class="rsc-welcome-text">
                    ...
                    <h3><?php
                        ...
                        echo rsc_esc_html( $welcome_widgets_copy['content']['title'] ); ?></h3>
                    <p><?php
                        // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                        echo rsc_esc_html( $welcome_widgets_copy['content']['description'] ); ?></p>
                </div>
            ...
            <div class="rsc-half-section">
                ...
                <div class="rsc-welcome-text">
                    ...
                    <h3><?php
                        // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                        echo rsc_esc_html( $welcome_widgets_copy['integrations']['title'] ); ?></h3>
                    <p><?php
                        // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                        echo rsc_esc_html( $welcome_widgets_copy['integrations']['description'] ); ?></p>
                </div>
    ...
    <div class="rsc-premium-section">
        ...
        <div class="rsc-premium-features">
            <?php if (!restrict_fs()->can_use_premium_code()) { ?>
                <span><?php esc_html_e('Upgrade to the premium version and get the following features', 'restricted-content'); ?></span>

                <a href="https://restrict.io/pricing/" target="_blank" class="button-primary rsc-premium-button"><?php esc_html_e('GO PREMIUM', 'restricted-content'); ?></a>
            <?php } ?>
            ...
            <div class="rsc-sections-wrap">
                ...
                <div class="rsc-half-section">
                    ...
                    <div class="rsc-welcome-text">
                        ...
                        <h3><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['shortcodes']['title'] ); ?></h3>
                        <p><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['shortcodes']['description'] ); ?></p>
                    </div>
                ...
                <div class="rsc-half-section">
                    ...
                    <div class="rsc-welcome-text">
                        ...
                        <h3><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['category']['title'] ); ?></h3>
                        <p><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['category']['description'] ); ?></p>
                    </div>
                ...
                <div class="rsc-half-section">
                    ...
                    <div class="rsc-welcome-text">
                        ...
                        <h3><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['widgets']['title'] ); ?></h3>
                        <p><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['widgets']['description'] ); ?></p>
                    </div>
                ...
                <div class="rsc-half-section">
                    ...
                    <div class="rsc-welcome-text">
                        ...
                        <h3><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['login']['title'] ); ?></h3>
                        <p><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['login']['description'] ); ?></p>
                ...
                <div class="rsc-half-section">
                    ...
                    <div class="rsc-welcome-text">
                        ...
                        <h3><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['site_shield']['title'] ); ?></h3>
                        <p><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['site_shield']['description'] ); ?></p>
                ...
                <div class="rsc-half-section">
                    ...
                    <div class="rsc-welcome-text">
                        ...
                        <h3><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['hide_show_menu']['title'] ); ?></h3>
                        <p><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['hide_show_menu']['description'] ); ?></p>
                    </div>
                ...
                <div class="rsc-half-section">
                    ...
                    <div class="rsc-welcome-text">
                        ...
                        <h3><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['bots_crawlers']['title'] ); ?></h3>
                        <p><?php
                            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is being escaped/sanitized using rsc_esc_html().
                            echo rsc_esc_html( $welcome_widgets_copy['bots_crawlers']['description'] ); ?></p>
                    </div>
